...
export class AuthService {
  ...
  public login(credentials: LoginDTO): Observable<Token> {
    return this.http.post<Token>(`/auth/login`, credentials, httpOptions);
  }
  ...
  public restorePassword(form: { email: string }): Observable<any> {
    return this.http.post<any>(`/restore-password/`, form)
  }
}
